<template>
  <div class="cart">
    <order-header :title="title" :description="description"> </order-header>
    <div class="wrapper">
      <div class="container">
        <div class="cart-box">
          ...
          <ul class="cart-item-list">
            ...
            >
              ...
              <div class="item-del" @click="delProductData(item)"></div>
            </li>
          </ul>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      checkedNum: 0, //选中商品数量
      title: "我的购物车",
      description: "温馨提示：产品是否购买成功，以最终下单为准哦，请尽快结算",
    };
  },
  mounted() {
  ...
  methods: {
    ...
    // 删除购物车商品
    delProductData(item) {
      deleteCartProduct(item.productId).then((res) => {
